...
public class GodotFacebook extends GodotPlugin {
    ...
    public void gameRequest(final String message, final String[] recipients, final String objectId)
    {
    ...
    {
        Log.i("godot", "Facebook login Zarbia");
    ...
    public void findFriends() {
        Log.i("godot", "Facebook findFriends");
        activity.runOnUiThread(new Runnable()
        {
            @Override public void run()
            {
                    ...
                    dialog.registerCallback(
                            ...
                            new FacebookCallback<FriendFinderDialog.Result>() {
                                ...
                                public void onSuccess(FriendFinderDialog.Result friendFinderResult) {
                                    Log.e(TAG, "Player Finder Dialog closed");
                                    Log.e(TAG,friendFinderResult.toString());
                                }

                                @Override
                                public void onCancel() {
                                    Log.e(TAG, "Player Finder canceled");
                                }
